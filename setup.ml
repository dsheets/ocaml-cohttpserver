...
(* OASIS_START *)
(* DO NOT EDIT (digest: 657b051ed70c13fd84101f3e808b755e) *)
(*
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$simple_client", []))];
          ...
          ("simple_httpd",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$simple_httpd", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 })
       ];
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["Anil Madhavapeddy"; "Stefano Zacchiroli"; "David Sheets"];
          homepage = None;
            ...
            [
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "cohttpd";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     cs_name = "simple_client";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "simple_client.ml"; });
               Flag
                 ({
                     cs_name = "tests";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "simple.ml"; })
            ];
